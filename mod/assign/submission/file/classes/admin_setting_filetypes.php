...
class admin_setting_filetypes extends admin_setting {
    ...
    public function __construct() {
        ...
        parent::__construct('assignsubmission_file/filetypes',
                get_string('filetypes', 'assignsubmission_file'),
                get_string('filetypes_desc', 'assignsubmission_file'), $defaults);
    }
    ...
    public function output_html($data, $query='') {
        ...
        $out .= html_writer::tag('th', get_string('displaydescription', 'assignsubmission_file'));
        $out .= html_writer::tag('th', get_string('fileextensions', 'assignsubmission_file'));
