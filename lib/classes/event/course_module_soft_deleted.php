 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */
class course_module_soft_deleted extends base {
    ...
    public static function get_name() {
        ...
        return 'eventcoursemodulesoftdeleted';
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' soft deleted the '{$this->other['modulename']}' activity with " .
